...
<section class="probootstrap-section probootstrap-section-colored probootstrap-bg probootstrap-custom-heading probootstrap-tab-section" style="background-image: url(<?php if( get_theme_mod( 'set_page-team-imagebg' ) != ''){ echo get_theme_mod( 'set_page-team-imagebg' ); }else{ header_image(); } ?>)">
	<div class="container">
		<div class="row">
			<div class="col-md-12 text-left section-heading probootstrap-animate">
				<h1>
				<?php
					if( get_theme_mod( 'set_page-team-heading' ) != ''){
						echo get_theme_mod( 'set_page-team-heading' );
					}else{ the_title();}
				?>
				</h1>
			</div>
